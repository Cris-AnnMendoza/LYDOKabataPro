...
.print-bar{background:#0d3b6e;color:#fff;padding:12px 24px;border-radius:12px;margin-bottom:20px;display:flex;align-items:center;gap:14px;width:100%;max-width:960px;flex-wrap:wrap}
...
.cert-wrap{width:960px;max-width:100%;background:#fff;position:relative;overflow:hidden;box-shadow:0 8px 40px rgba(0,0,0,.2)}
...
.cert-content{position:relative;z-index:3;padding:44px 64px;text-align:center}
.cert-header{display:flex;align-items:center;justify-content:center;gap:22px;margin-bottom:22px}
.cert-seal{width:72px;height:72px;border-radius:50%;display:flex;align-items:center;justify-content:center;color:#fff;font-size:1.8rem;box-shadow:0 4px 16px rgba(0,0,0,.2);flex-shrink:0;overflow:hidden}
.cert-org-main{font-size:1rem;font-weight:800;color:#0d3b6e;letter-spacing:.02em}
.cert-org-sub{font-size:.75rem;color:#475569;font-weight:500;margin-top:2px}
.gold-line{height:3px;background:linear-gradient(90deg,transparent,#c8a84b,#f0d060,#c8a84b,transparent);margin:16px 0;border-radius:2px}
.thin-line{height:1px;background:linear-gradient(90deg,transparent,#e2e8f0,transparent);margin:12px 0}
.cert-type{font-size:.82rem;font-weight:700;letter-spacing:.2em;text-transform:uppercase;color:#c8a84b;margin-bottom:6px}
.cert-title{font-family:'Playfair Display',serif;font-size:2.4rem;font-weight:900;color:#0d3b6e;line-height:1.1;margin-bottom:4px}
.cert-presented{font-size:.85rem;color:#475569;margin:18px 0 6px;font-style:italic}
.cert-name{font-family:'Playfair Display',serif;font-size:2.2rem;font-weight:700;color:#1565c0;border-bottom:2px solid #c8a84b;display:inline-block;padding-bottom:3px;margin-bottom:6px;min-width:360px}
.cert-barangay{font-size:.82rem;color:#475569}
.cert-body{font-size:.88rem;color:#475569;line-height:1.8;margin:16px 0;max-width:580px;margin-left:auto;margin-right:auto}
.cert-event{font-weight:700;color:#0d3b6e;font-size:.95rem}

/* Footer */
.cert-footer{display:grid;grid-template-columns:1fr auto 1fr;gap:16px;margin-top:28px;align-items:end}
.cert-sig{text-align:center}
.cert-sig-line{height:1px;background:#1565c0;margin-bottom:5px}
.cert-sig-name{font-size:.78rem;font-weight:700;color:#0d3b6e}
.cert-sig-title{font-size:.68rem;color:#475569}
.cert-info-box{background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:10px 14px;text-align:center}
.cert-info-label{font-size:.65rem;color:#94a3b8;text-transform:uppercase;letter-spacing:.05em}
.cert-info-val{font-size:.82rem;font-weight:700;color:#0d3b6e;margin-top:2px}

/* Verification QR */
.verify-box{display:flex;flex-direction:column;align-items:center;gap:4px}
.verify-box #certQR canvas,
.verify-box #certQR img{border-radius:6px;border:1px solid #e2e8f0}
.verify-label{font-size:.6rem;color:#94a3b8;text-align:center;max-width:90px;line-height:1.4}
...
.cert-note{font-size:.68rem;color:#94a3b8;margin-top:16px}
  ...
  <div class="cert-content">
    ...
    <div class="cert-header">
      ...
      <div>
        ...
        <div style="font-size:.68rem;color:#94a3b8;margin-top:1px">Sta. Cruz, Laguna 4009 · Philippines</div>
      </div>
    ...
    <div class="cert-note">
      This certificate is issued in recognition of active participation in youth development activities.
      Cert No: <?= htmlspecialchars($certNo) ?> · Verify at: <?= htmlspecialchars($verifyUrl) ?>
    </div>
