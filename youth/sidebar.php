...
<aside class="y-sidebar" id="ySidebar">
  <div class="y-sidebar-logo">
    <div class="y-logo-icon"><i class="fas fa-seedling"></i></div>
  ...
  <nav class="y-nav">
    ...
    <?php youthNav('resume.php',     'file-alt',       'My Resume') ?>
    <?php youthNav('ai_resume.php',  'magic',          'AI Resume Builder') ?>
    <?php youthNav('ai_assistant.php','robot',         'AI Well-being Assistant', 0) ?>
