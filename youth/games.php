...
// ── TRIVIA ────────────────────────────────────────────────
const TRIVIA=[
  {q:'What does LYDO stand for?',opts:['Local Youth Development Office','Laguna Youth Development Organization','Local Youth Driven Operations','Laguna Youth District Office'],a:0},
  {q:'What is the minimum age to be considered part of the youth sector in the Philippines?',opts:['12 years old','15 years old','18 years old','10 years old'],a:0},
  {q:'What law governs the National Youth Commission in the Philippines?',opts:['RA 8044','RA 7160','RA 9163','RA 10533'],a:0},
  {q:'Sta. Cruz is the capital of which province?',opts:['Laguna','Batangas','Quezon','Cavite'],a:0},
  {q:'What is the Sangguniang Kabataan (SK)?',opts:['Youth council at the barangay level','A national youth organization','A government scholarship program','A youth sports league'],a:0},
  {q:'Which of these is a right of Filipino youth under the law?',opts:['Right to education','Right to vote at age 15','Right to own property at 16','Right to run for president at 18'],a:0},
  {q:'What does "Kabataan" mean in English?',opts:['Youth','Community','Leadership','Service'],a:0},
  {q:'The LYDO system helps youth organizations with which of the following?',opts:['Registration, programs, and community engagement','Tax filing and business permits','Land titling and property records','Vehicle registration'],a:0},
  {q:'What is the maximum age to be part of the youth sector in the Philippines?',opts:['30 years old','25 years old','35 years old','28 years old'],a:0},
  {q:'Which value is most important for youth leaders according to LYDO?',opts:['Integrity and service','Wealth and fame','Power and authority','Competition and rivalry'],a:0},
];
...
function loadTrivia(){
  ...
  if(triviaIdx>=TRIVIA.length){
    c.innerHTML='<div class="score-box"><div style="font-size:1.1rem;opacity:.85">Quiz Complete!</div><div class="score-num">'+triviaScore+'/'+TRIVIA.length+'</div><div style="opacity:.8;margin-bottom:20px">'+(triviaScore>=8?'Excellent! You know your youth rights!':triviaScore>=5?'Good job! Keep learning!':'Keep studying about youth development!')+'</div><button class="btn-game btn-primary-g" onclick="triviaIdx=0;triviaScore=0;loadTrivia()"><i class="fas fa-redo"></i> Play Again</button></div>';
    return;
  }
...
if(document.getElementById('triviaContainer'))loadTrivia();
</script>
</body>
</html>
