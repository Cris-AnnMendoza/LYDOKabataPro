    ...
    <div class="card">
      ...
      <div style="padding:8px 18px">
        ...
        <div class="doc-row">
          ...
          <a href="../shared/uploads/scholarship/<?=htmlspecialchars($doc['file_path'])?>" target="_blank" class="act-btn" style="background:#e3f2fd;color:#1565c0;border-color:#90caf9;text-decoration:none" title="View Document">
