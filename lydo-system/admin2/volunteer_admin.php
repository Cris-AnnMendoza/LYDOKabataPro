...
<div id="addProgModal" class="modal-overlay" style="display:none">
  <div class="modal-box" style="max-width:580px;max-height:90vh;overflow:hidden">
    ...
    <form method="POST" class="modal-body" style="overflow-y:auto;max-height:calc(90vh - 140px)">
