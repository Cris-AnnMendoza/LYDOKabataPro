...
const MERIT_RULES = [
    ...
    'requirements_on_time'   => ['points' =>  1, 'type' => 'merit',   'label' => 'Submission of required documents (complete & on time)'],
    'representative_sent'    => ['points' =>  1, 'type' => 'merit',   'label' => 'Sending of official representative (if official delegate cannot attend)'],
    'volunteer_contribution' => ['points' =>  2, 'type' => 'merit',   'label' => 'Extra contribution (volunteers, resources, initiatives aligned to the program)'],
    'invitation_present'     => ['points' =>  1, 'type' => 'merit',   'label' => 'Attendance in invitations/activities organized by fellow MYDC member organizations'],
    // Demerit
    'official_event_absent'  => ['points' => -2, 'type' => 'demerit', 'label' => 'Unexcused absence in Official Event'],
    'meeting_absent'         => ['points' => -1, 'type' => 'demerit', 'label' => 'Unexcused absence in Patawag/Meeting'],
    'no_representative'      => ['points' => -2, 'type' => 'demerit', 'label' => 'No representative sent (without valid reason in writing signed by Adviser and Principal/Dean/College Head or equivalent)'],
    'late_submission'        => ['points' => -1, 'type' => 'demerit', 'label' => 'Late submission of requirements/documents'],
    'consecutive_absences'   => ['points' => -3, 'type' => 'demerit', 'label' => 'Repeated negligence (3 consecutive absences without coordination)'],
];
