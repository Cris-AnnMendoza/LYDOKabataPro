...
$byMonth = $pdo->prepare("SELECT DATE_FORMAT(created_at,'%b %Y') as mo, YEAR(created_at) as yr, MONTH(created_at) as mn, COUNT(*) as cnt FROM youth_users WHERE 1=1 $scopeWhere GROUP BY yr,mn ORDER BY yr DESC,mn DESC LIMIT 12");
